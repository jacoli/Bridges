...
public class ImageTouchView extends ImageView {
    ...
    private Matrix orgMatritx = null;
...
//        if (orgMatritx == null) {
//
//            orgMatritx = new Matrix();
//            orgMatritx.set(this.getImageMatrix());
//        }
...
//                doubleMatrix.set(orgMatritx);
//
//                if (realscale >= 1.5) {
//                    realscale = 1;
//                    doubleMatrix.postScale(realscale, realscale, 0, 0);
//                }
//                else  {
//                    realscale = 2;
//                    doubleMatrix.postScale(realscale, realscale, 0, 0);
//                }
//
//                this.setImageMatrix(doubleMatrix);
//                firClick = 0;
//                mode = 0;
//                matrix.set(doubleMatrix);
//                return true;
//            }
//            else {
